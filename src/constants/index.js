...
const socials = [
  ...
  },
  {
    ...
    bg: "#05b6f6",
    link: "https://www.linkedin.com/in/aayush-sharma-43b472331/",
  },
];
  ...
  children: [
      ...
      children: [
        {
          ...
          description: [
            "A sleek and responsive weather app that fetches real-time data using a weather API.",
            " It shows temperature, conditions, and location details with a clean UI.",
            "Built for speed, accuracy, and a smooth user experience across all devices.",
            "It's built with React.js and CSS, ensuring fast performance, responsive design, and a clean, premium look.",
          ],
        },
        {
          id: 2,
          ...
          kind: "file",
          fileType: "url",
          href: "https://weatherayush.netlify.app",
    ...
    // ▶ Project 2
    {
      ...
      children: [
        ...
        {
          id: 2,
          name: "Amazon clone.com",
          icon: "/images/safari.png",
          kind: "file",
          fileType: "url",
          href: "https://github.com/aayush-webdev/amazon_clone_using-Html-Css3",
